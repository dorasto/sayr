...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Popup>, SheetContentProps>(
	({ side = "right", className, children, showClose = true, overlay = true, portal = true, ...props }, ref) => (
		<SheetPortal>
