 ...
 *
 * - Self-hosted: always true (AI availability is controlled by REQUESTY_API_KEY at the instance level).
 ...
 *
 * - Self-hosted: always true (AI availability is controlled by REQUESTY_API_KEY).
 * - Cloud free: false.
 * - Cloud pro: true.
 *
 * **Server-side only** -- calls getEdition() which reads process.env.
