...
export const dummyIssues = [
  ...
  {
    id: "7262",
    title: "The UTF8 application is down, parse the neural bandwidth so we can back up the PNG bandwidth!",
    description: "The UTF8 application is down, parse the neural bandwidth so we can back up the PNG bandwidth!",
    status: "done",
    labels: ["feature"],
    priority: "high",
    assignee: "Tommerty",
