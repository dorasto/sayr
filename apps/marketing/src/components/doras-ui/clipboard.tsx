...
export default function Clipboard({
	...
	const triggerElement = children ? (
		<button
			...
			className="cursor-pointer border-none bg-transparent p-0 aspect-square"
		...
		>
			<div className={cn("transition-all size-4", copied ? "scale-100 opacity-100" : "scale-0 opacity-0")}>
				{defaultCheckIcon}
			</div>
			<div
				className={cn(
					"absolute transition-all size-4",
