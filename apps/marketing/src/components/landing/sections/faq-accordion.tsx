...
const faqs = [
	{
		...
		a: "Linear and Jira are internal-only tools. Your users never see your board. Sayr has the same project management capabilities \u2014 kanban boards, sprints, priorities, GitHub integration \u2014 but adds a public-facing portal where external users can view tasks, vote, submit feedback, and track progress. You control exactly what's visible.",
	},
	{
	...
	},
	{
		...
		a: "Visibility in Sayr is set at the entity level. Each task can be marked as public or private \u2014 private tasks are completely hidden from external users. Labels also have their own visibility, so you can have public labels like 'Bug' alongside private ones like 'Sprint 16'. Comments can be public or internal \u2014 internal comments are only visible to your team. When a task is public, external users see it along with its public labels and public comments.",
	},
	{
		q: "Can external users create accounts?",
		a: "Yes. External users can sign up through your public portal using OAuth (GitHub, etc.) and submit bug reports, feature requests, vote on existing tasks, and leave public comments. They're given a distinct external role with limited permissions \u2014 they can never see internal data.",
	},
	{
