...
export function ComparisonSection() {
  ...
  const renderCell = (val: boolean | string) => {
    ...
    if (val === "partial")
      return <span className="text-[10px] text-muted-foreground">Partial</span>;
      ...
      <div className="max-w-(--breakpoint-md) mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground max-w-lg mx-auto">
            Linear is powerful but closed. Canny collects feedback but doesn't
            manage work. Sayr does both — and it's source available.
          </p>
        </div>
