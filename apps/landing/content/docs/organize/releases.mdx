...
Everything above can also be done from your terminal or a script with the [Sayr CLI](/docs/cli): create, edit, publish, and delete releases, manage their labels, post status updates and comments, and link GitHub pull requests. Personal access tokens reach the same actions through the `/v1/me/releases` routes of the [public API](/docs/api/overview).
