...
<FeatureStep
	...
	description="All Sayr services are published as Docker images. Use the provided docker-compose.yml as your starting point and configure via environment variables."
/>

<FeatureStep
	number="02"
	title="Point at your database and storage"
	description="Set your PostgreSQL connection string, Redis URL, and S3-compatible storage credentials. Run the database migrations and the schema is ready."
/>

<FeatureStep
	number="03"
	title="Configure your domain and OAuth"
	description="Set your base domain and configure whichever OAuth providers you want to offer. Your public portal will be accessible at {org-slug}.yourdomain.com automatically."
/>
