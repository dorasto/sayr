...
<FeatureStep
	...
	description="Install Sayr's GitHub App on your GitHub account or organisation. Takes about 30 seconds from the Integrations settings page."
/>

<FeatureStep
	number="02"
	title="Map repos to categories"
	description="Choose which repositories connect to which Sayr categories. One repo per category, or multiple repos to the same category — your call."
/>

<FeatureStep
	number="03"
	title="Reference tasks in your workflow"
	description="Use task IDs in commits, PR titles, and issue bodies. Sayr picks these up automatically and updates task timelines and statuses."
/>
