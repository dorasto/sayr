...
<FeatureStep
	number="01"
	title="Create tasks privately"
	description="By default, every new task is private. Your team can work on it, discuss it internally, and iterate before anyone outside sees it."
/>

<FeatureStep
	number="02"
	title="Set visibility per entity"
	description="When you're ready, toggle a task to public. Do the same for the labels and comments you want to expose. Everything else stays hidden."
/>

<FeatureStep
	number="03"
	title="Users see a curated view"
	description="The public portal automatically shows only public tasks with public labels and public comments. Internal content is stripped from the response server-side — it's never sent to the browser."
/>
