...
function TooltipContent({
	...
	return (
		...
		// Dialog/panel's own portal by default, which can trap it behind normal
		// page content when that ancestor is transform-centered. Force
		// document.body (Base UI's own documented default) to avoid that.
