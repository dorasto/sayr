import { Code2, GitFork, Github, Server, Users } from "lucide-react";
				...
				<div className="relative overflow-hidden rounded-3xl border p-10 md:p-16">
					...
					<div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
						<div>
							...
							<h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4">100% Source-Available</h2>
							<p className="text-muted-foreground mb-6">
								Every line of code is public. Fork it, self-host it on your own infrastructure with Docker, or
								contribute back to the project. No vendor lock-in, no surprises.
							</p>
							<div className="flex flex-wrap gap-3">
								...
								<Button
									...
									render={<a href="/docs/contributing/local-development">Contribute</a>}
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-3">
							{highlights.map((h) => {
								const Icon = h.icon;
								return (
									<div key={h.title} className="rounded-xl border bg-card/80 p-4 space-y-2">
