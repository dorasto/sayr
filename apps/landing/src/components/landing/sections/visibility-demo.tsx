				...
				<div className="grid md:grid-cols-2 gap-12 items-start">
					<div className="md:sticky md:top-24">
						...
						<p className="text-muted-foreground mb-4">
							Toggle between what your team sees internally and what external users see on the public portal.
							Private tasks, internal labels, and internal comments disappear from the public view entirely.
						</p>
						<p className="text-sm text-muted-foreground mb-6">
							Visibility is set at the entity level — each task is public or private, each label is public or
							private, and each comment is public or internal.
						</p>
						...
						<div className="rounded-2xl border bg-card shadow-xl overflow-hidden">
							...
							<div className="p-5 space-y-3">
								...
								<p className="text-xs text-muted-foreground leading-relaxed">
									Users have been requesting a dark theme for the main dashboard. This would improve
									accessibility and reduce eye strain during extended sessions.
								</p>
												...
												>
													<div className="py-2 px-3 rounded-md bg-primary/5 border border-dashed border-primary/15 text-xs">
														<div className="flex items-center gap-1.5 mb-0.5">
															...
															<Badge
																variant="outline"
																className="text-[9px] py-0 px-1 border-primary/20 text-primary"
															>
																Internal
															</Badge>
									...
									<div className="rounded-2xl border border-dashed border-primary/20 bg-card shadow-lg overflow-hidden">
										<div className="px-5 py-3 border-b bg-primary/5 flex items-center justify-between">
											<div className="flex items-center gap-2">
												...
												<Badge
													className="text-[10px] py-0 border-primary/20 text-primary"
													variant="outline"
												>
										...
										<div className="p-5 space-y-3">
											...
											<p className="text-xs text-muted-foreground leading-relaxed">
												Move from JWT tokens to httpOnly session cookies for improved security. Requires
												backend refactor and client-side auth flow updates.
											</p>
											<div className="flex flex-wrap gap-1.5">
												<span className="inline-flex items-center gap-1 text-[10px] py-0.5 px-2 rounded-full bg-muted border border-border">
								...
								{isPublic ? (
									<>
										...
										<div>
											...
											<p>
												External users see the public task with its public labels and public comments. The
												private task, private labels, and internal comments are completely hidden.
											</p>
										</div>
									</>
								) : (
									<>
										...
										<div>
											...
											<p>
												Your team sees everything — both public and private tasks, all labels regardless of
												visibility, and all comments including internal ones.
											</p>
										</div>
									</>
								)}
