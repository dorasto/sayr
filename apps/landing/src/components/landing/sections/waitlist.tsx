...
const capWidgetStyles = {
	...
	"--cap-gap": "10px",
	"--cap-font": 'system-ui, -apple-system, "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", sans-serif',
						...
						<div className="relative flex items-center w-full rounded-full border bg-card/80 backdrop-blur shadow-lg shadow-primary/5 overflow-hidden transition-colors focus-within:border-primary/30">
							...
							{!captchaToken ? (
								<div className="m-1.5 shrink-0">
									...
									<cap-widget
										ref={widgetRef}
										data-cap-api-endpoint={import.meta.env.PUBLIC_CAP_API_ENDPOINT}
				...
				<div className="flex flex-col items-center gap-3 py-2">
					...
					<div className="text-center">
						...
						<p className="text-xs text-muted-foreground mt-1">
							We'll reach out to <span className="font-medium text-foreground">{email}</span> when we're ready.
						</p>
					</div>
				</div>
			)}
