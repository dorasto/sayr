import { ArrowRight, Check, ClipboardList, EyeOff, Layers, Mail, MessageSquareText, RotateCcw, X } from "lucide-react";
			...
			<div className="max-w-(--breakpoint-lg) mx-auto">
				...
				<div className="text-center mb-16">
					...
					<h2 className="text-3xl md:text-4xl font-semibold tracking-tight max-w-3xl mx-auto">
						Your team and your users shouldn't need <span className="text-muted-foreground">separate tools.</span>
					</h2>
					<p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
						Most teams juggle a project management tool and a separate feedback tool. That means duplicated work,
						stale updates, and users who never know what's happening.
					</p>
				</div>
