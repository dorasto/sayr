import { Database, Globe, MapPin, Server } from "lucide-react";
				...
				<div className="relative overflow-hidden rounded-3xl border bg-card/60 p-8 md:p-12">
					...
					<div className="relative z-10 flex flex-col md:flex-row gap-10 items-start">
						...
						<div className="shrink-0 max-w-xs">
							<Badge variant="secondary" className="rounded-full py-1 px-3 mb-4 text-xs">
								Built in the EU 🇪🇺
							</Badge>
							...
							<p className="text-sm text-muted-foreground leading-relaxed!">
								Sayr is owned and operated by the Irish company Doras Media Ltd, running on EU infrastructure.
							</p>
							<a
						...
						<div className="flex-1 grid grid-cols-2 gap-3">
							{euPoints.map((p) => {
								const Icon = p.icon;
								return (
									<div key={p.title} className="rounded-xl border bg-background/60 p-4 space-y-2">
