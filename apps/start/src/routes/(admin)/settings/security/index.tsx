...
function RouteComponent() {
  ...
  const [pendingTwoFactorEnable, setPendingTwoFactorEnable] = useState<
    boolean | null
  >(null);
  ...
  const [showSetupBackupCodesDialog, setShowSetupBackupCodesDialog] =
    useState(false);
  const [setupBackupCodes, setSetupBackupCodes] = useState<string[]>([]);
  const [showViewBackupCodesDialog, setShowViewBackupCodesDialog] =
    useState(false);
  const [showGenerateBackupDialog, setShowGenerateBackupDialog] =
    useState(false);
          ...
          {twoFactorEnabled && (
            <div className="px-4 pb-4 pt-2 flex flex-col gap-2">
              <p className="text-xs text-muted-foreground">
                Backup codes let you recover access if you lose your
                authenticator.
              </p>
