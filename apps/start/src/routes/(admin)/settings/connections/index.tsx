...
function RouteComponent() {
	const { email, githubUser, dorasUser, discordUser, slackUser, providers } = Route.useLoaderData();
	return (
		<SubWrapper title="Connections" style="compact">
			<UserConnections email={email} githubUser={githubUser} dorasUser={dorasUser} discordUser={discordUser} slackUser={slackUser} providers={providers} />
		</SubWrapper>
	);
}
