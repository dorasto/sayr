...
import { type HeadlessToastOptions, headlessToast } from "@repo/ui/components/headless-toast";
import { captureUserFacingError } from "@/components/post-hog-provider";
 ...
 */
export const toast = Object.assign((opts: HeadlessToastOptions) => headlessToast(opts), {
