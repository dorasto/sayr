 ...
 */
const ITEM_CUSTOMIZATIONS: Record<
	string,
	Partial<DefaultReactSuggestionItem>
> = {
	"Heading 1": {
		title: "Heading",
 ...
 */
export const reorganizeSlashMenuItems = (
	...
	for (const [groupName, itemTitles] of Object.entries(CUSTOM_GROUPS)) {
		for (const itemTitle of itemTitles) {
			...
			if (
				...
				!EXCLUDED_ITEMS.includes(item.title)
			) {
 ...
 */
export const insertHelloWorldItem = (
