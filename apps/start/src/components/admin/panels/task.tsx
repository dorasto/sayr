...
import { IconCopy, IconGitBranch, IconLink, IconUsers } from "@tabler/icons-react";
	...
	return (
		<div className="flex items-center gap-2 w-full flex-1 min-w-0">
			...
			<div className="flex items-center gap-2 ml-auto">
				...
				/>
				<SimpleClipboard
					textToCopy={formatTaskKey(organization.shortId, task.shortId)}
					variant={"primary"}
					className="h-6 p-1 w-fit bg-transparent"
					...
					onCopy={() =>
						headlessToast({
							title: formatTaskKey(organization.shortId, task.shortId),
