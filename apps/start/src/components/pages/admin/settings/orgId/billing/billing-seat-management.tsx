    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <SelectTrigger
            size="sm"
            className="w-auto min-w-28 bg-accent! rounded-lg border-transparent"
          >
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
        ...
        <AlertDialog open={adjustOpen} onOpenChange={handleAdjustOpen}>
          <AlertDialogTrigger asChild>
            <Button variant="primary" className="ml-auto h-8">
              Adjust seats
            </Button>
          </AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription asChild>
                <Label variant={"description"}>
                  Change the number of seats on your subscription. You cannot go
                  below the number of currently assigned seats ({assignedCount}
                  ).
                </Label>
              </AlertDialogDescription>
            </AlertDialogHeader>
                  ...
                  >
									...
									<input
										...
										onChange={(e) => {
											...
											if (!Number.isNaN(parsed)) {
												setNewSeatCount(Math.max(minSeats, Math.min(MAX_SEATS, parsed)));
											}
										}}
										onBlur={() => {
                    ...
                    />
								...
								<Button
										...
										onClick={() => setNewSeatCount((c) => Math.min(MAX_SEATS, c + 1))}
									>
      ...
      <div className="rounded-lg border border-border overflow-hidden">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="w-10">Seat</TableHead>
