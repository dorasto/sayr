                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <CheckboxItem
                      ...
                      onCheckedChange={(checked) =>
                        updateTasksPermission("deleteAny", checked)
                      }
                      disabled={isAdmin}
                    />
                    <CheckboxItem
            ...
            <CollapsibleTrigger asChild>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="text-xs">
                    {
                      Object.values(permissions.moderation).filter(Boolean)
                        .length
                    }
                    /3
                  </Badge>
            ...
            <CollapsibleContent>
              <div className="pl-4 pr-2 pb-2 flex flex-col gap-2">
                ...
                <PermissionRow
                  ...
                  onCheckedChange={(checked) =>
                    updateModerationPermission("approveSubmissions", checked)
                  }
                  disabled={isAdmin}
                />
                <PermissionRow
                  ...
                  onCheckedChange={(checked) =>
                    updateModerationPermission("manageVotes", checked)
                  }
                  disabled={isAdmin}
                />
              </div>
