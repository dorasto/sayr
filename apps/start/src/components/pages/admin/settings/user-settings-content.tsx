...
import { IconAlertTriangle, IconCheck, IconChevronDown, IconPhoto, IconTrash } from "@tabler/icons-react";
import { useStore } from "@tanstack/react-store";
import { useCallback, useState } from "react";
import { useTheme } from "@/components/theme-provider";
import { useFileUpload } from "@/hooks/use-file-upload";
import { deleteUserAction, updateUserAction, uploadUserProfilePicture } from "@/lib/fetches/user";
 ...
 */
export function UserSettingsContent({ account, organizations = [], onAccountUpdated }: UserSettingsContentProps) {
		...
		<div className="bg-card rounded-lg flex flex-col">
			...
			<Tile className="md:w-full items-start" variant={"transparent"}>
				<TileHeader className="md:w-full">
					...
					<TileDescription className="text-xs">Your profile picture and display name</TileDescription>
				</TileHeader>
			...
			<Tile className="md:w-full">
				<TileHeader>
					...
					<TileDescription className="text-xs">Cannot be changed at present</TileDescription>
				</TileHeader>
				<TileAction>
						...
						<AlertDialogContent>
							...
							<div className="flex items-start gap-3 p-4 rounded-lg bg-destructive/10 border border-destructive/20">
								...
								<div className="flex flex-col gap-1">
									<Label className="text-destructive font-medium">Before you delete your account:</Label>
			...
			{isDialog == false && (
				<Tile className="md:w-full">
					<TileHeader>
						...
						<TileDescription className="text-xs">Choose how tasks open when clicked from lists</TileDescription>
					</TileHeader>
					<TileAction>
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
							...
							<DropdownMenuContent align="end">
								<DropdownMenuRadioGroup
									value={taskOpenMode}
									onValueChange={(v) => userPreferencesActions.setTaskOpenMode(v as "dialog" | "page")}
								>
									<DropdownMenuRadioItem value="dialog">Dialog</DropdownMenuRadioItem>
