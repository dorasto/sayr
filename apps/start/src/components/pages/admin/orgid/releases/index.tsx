...
import {
  ReleasesListPanelContent,
  ReleasesListPanelHeader,
} from "@/components/admin/panels/releases-list";
...
export default function OrganizationReleasesPage() {
  ...
  return (
    <PanelWrapper
      ...
      setOpen={(open) =>
        open
          ? releasesListPanelActions.open()
          : releasesListPanelActions.close()
      }
