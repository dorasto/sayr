		...
		<div className="flex flex-col gap-3">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Custom filtered views of your tasks</p>
				</div>
			...
			<div className="flex flex-col gap-3">
				{views.map((view) => (
					<Tile
						className={cn("bg-card hover:bg-accent md:w-full transition-colors cursor-pointer h-full p-0 gap-0")}
						key={view.id}
						// style={{
			...
			{views.length === 0 && (
				<div className="flex flex-col items-center justify-center p-12 text-center border rounded-lg border-dashed bg-muted/20">
					...
					<p className="text-sm text-muted-foreground mb-4 max-w-md">
						Create custom filtered views to quickly access specific sets of tasks. Views can be created from the
						tasks page or in settings.
					</p>
