...
export function GenerateBackupCodesDialog({ open, onOpenChange }: GenerateBackupCodesDialogProps) {
			...
			<DialogContent className="max-w-md">
				...
				{generatedCodes.length === 0 ? (
					...
					<>
						...
						<DialogFooter>
							<Button variant="outline" onClick={() => handleDownloadBackupCodes(generatedCodes)}>
