...
function FilterComboBox({
    ...
    () =>
      config.empty
        ? [
            ...
            { value: "__empty__", label: config.empty },
          ]
        : getAvailableOptions(config.field),
  ...
  const displayLabels = useMemo(
    () => formatSelectedLabels(selectedValues, options),
            ...
            {conditions.length > 0 && (
              <div className="space-y-2">
                ...
                {conditions.map((condition) => {
                  const cfg = filteredConfigs.find(
                            ...
                            >
                              ...
                              <div className="flex flex-col items-start min-w-0 flex-1">
                                ...
                                <span className="truncate w-full">
                                  {formatSelectedLabels(values, options)
                                    .length <= 2
  ...
  return (
    ...
    >
      <DropdownMenuTrigger asChild>
        <Button
          variant="primary"
          className={cn("gap-2 h-6 w-fit p-1", activeFiltersCount > 0 && "w-6")}
        >
          <IconFilter2 className="w-4 h-4" />
