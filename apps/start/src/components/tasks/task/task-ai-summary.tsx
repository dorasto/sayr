			...
			<div className="flex flex-col gap-2">
									...
									<div>
										<div className="flex items-center gap-1.5 px-3 pt-1 pb-0.5">
											<span className="text-xs text-muted-foreground font-mono">
												url_fetch:{" "}
												<span
													className={promptDebug.urlFetchEnabled ? "text-green-500" : "text-destructive"}
												>
				...
				{renderedHtml && !loading && (
					<div className="flex flex-wrap wrap-anywhere gap-1">
						...
						<p className="text-xs text-muted-foreground">Review important information carefully.</p>
					</div>
				)}
