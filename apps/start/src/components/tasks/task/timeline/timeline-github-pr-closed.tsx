...
function parsePRClosedData(item: TimelineItemProps["item"]): GithubPRClosedData | null {
...
export function TimelineGithubPRClosed({
	...
	return (
		<TimelineItemWrapper showSeparator={showSeparator} item={item} icon={IconGitPullRequest} color={color}>
			PR{" "}
