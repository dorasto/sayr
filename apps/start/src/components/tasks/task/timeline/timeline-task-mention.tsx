...
export function TimelineTaskMentioned({
	...
	const statusIcon = statusCfg ? statusCfg.icon(cn(statusCfg.className, "h-3.5 w-3.5")) : undefined;
	...
	return (
		...
		>
			...
			{sourceTask ? (
				...
				<InlineLabel className="text-muted-foreground" text="another task" icon={<IconAt size={12} />} />
			)}
		</TimelineItemWrapper>
	);
}
