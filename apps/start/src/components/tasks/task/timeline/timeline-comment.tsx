...
function CommentHistoryDialog({
  ...
  useEffect(() => {
    async function fetchHistory() {
      ...
      try {
        const url = `${import.meta.env.VITE_APP_ENV === "development" ? import.meta.env.VITE_EXTERNAL_API_URL : ""}/admin/organization/task/get-comment-history?org_id=${orgId}&task_id=${taskId}&comment_id=${commentId}`;
