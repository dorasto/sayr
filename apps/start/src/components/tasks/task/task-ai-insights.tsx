...
import { BackgroundGradient } from "@repo/ui/components/doras-ui/gradient";
...
export function AiInsights({
  ...
  return (
    <BackgroundGradient preset="primary" spread={"soft"}>
      <div className="bg-card/90 p-3 rounded-xl">
      ...
      {/*<div className="rounded-xl border border-border bg-card p-3 flex flex-col divide-y divide-border [&>*+*]:pt-3">
        <AiTaskSummary task={task} orgId={orgId} embedded />
        <AiRecommendations {...recommendationsProps} embedded />
      </div>*/}
    </BackgroundGradient>
