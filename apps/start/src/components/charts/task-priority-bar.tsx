...
export function TaskPriorityBar({ tasks, size = "md", showLabels = true, className }: TaskPriorityBarProps) {
	...
	return (
		<SimpleBarChart data={chartData} layout="horizontal" size={size} showLabels={showLabels} className={className} />
	);
}
