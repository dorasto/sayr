...
import { IconChevronDown, IconChevronUp, IconSquarePlus2 } from "@tabler/icons-react";
import { useState } from "react";
import { StatusUpdateCard } from "./status-update-card";
import type { Health, Visibility } from "./types";
...
export function UpdatesList({
	...
	return (
		<div className="flex flex-col gap-2 rounded-xl border bg-card">
			...
			{latest && (
				<div className="px-3">
					<StatusUpdateCard key={latest.id} update={latest} {...sharedCardProps} />
				</div>
			)}
