						...
						<div className="flex flex-col">
							{icon ? (
								<div className="flex gap-2">
									<div className={cn("bg-accent p-1 rounded-lg [&_svg]:size-10! h-fit", iconClassName)}>
										{icon}
									</div>
									<div className="flex flex-col">
...
// PanelWrapper was removed — every consumer now goes through the shared
// Page/IndentDrawer/sidebar-store system (see components/generic/page.tsx,
// components/generic/use-page.tsx). It was a resizable-panel-group +
// mobile-Sheet layout that every route re-implemented its own open state
// for (isProjectPanelOpen and half a dozen ad-hoc TanStack Store panels) —
// Page centralizes that into one store with one persistence/animation
// story.
