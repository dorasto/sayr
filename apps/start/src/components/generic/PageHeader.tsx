...
export function PageHeader({ children, className }: PageHeaderProps) {
	...
	return (
		<div className={cn("sticky top-0 z-30 bg-background shrink-0 flex flex-col w-full", className)}>
			{isMobile && (
...
function Identity({ icon, title, children, actions, className }: IdentityProps) {
	return (
		<div className={cn("flex items-center gap-2 h-11 px-3 w-full shrink-0", className)}>
