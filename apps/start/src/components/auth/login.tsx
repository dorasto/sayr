...
import { authClient, signInDoras, signInEmail, signInEmailTwoFactor, signInGithub } from "@repo/auth/client";
		...
		<Dialog>
			...
			<DialogContent onOpenAutoFocus={(e) => e.preventDefault()}>
				<div className="flex flex-col items-center gap-2">
					...
					<DialogHeader>
						<DialogTitle className="sm:text-center">{import.meta.env.VITE_PROJECT_NAME}</DialogTitle>
	...
	return (
		<div className={cn("rounded-2xl mx-auto w-full max-w-prose", !isDialog && "bg-card border p-3")}>
			<div className="flex flex-col items-center gap-9">
				...
				{(providers?.doras || providers?.github) && (
