...
import { useCommandRegistry } from "@/app/hooks/use-command-registry";
import type { CommandGroup as CommandGroupType, CommandItem as CommandItemType } from "@/app/types/command";
