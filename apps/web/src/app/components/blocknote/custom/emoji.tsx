import type { DefaultReactGridSuggestionItem, GridSuggestionMenuProps } from "@blocknote/react";
		...
		>
			<div className="max-h-80 overflow-y-auto overflow-x-hidden p-2">
				<div
					...
					style={{ gridTemplateColumns: `repeat(${props.columns || 8}, minmax(0, 1fr))` }}
				>
			...
			{props.items.length === 0 && (
				<div className="py-6 text-center text-sm text-muted-foreground">No emojis found</div>
			)}
		</div>
	);
}
